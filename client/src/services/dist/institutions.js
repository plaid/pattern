...
exports.InstitutionsProvider = void 0;
var react_1 = require("react");
var api_1 = require("./api");
var initialState = {};
var InstitutionsContext = react_1.createContext(initialState);
/**
 * @desc Maintains the Institutions context state and provides functions to update that state.
 */
function InstitutionsProvider(props) {
    var _this = this;
    var _a = react_1.useReducer(reducer, initialState), institutionsById = _a[0], dispatch = _a[1];
    /**
     * @desc Requests details for a single Institution.
     */
    var getInstitutionById = react_1.useCallback(function (id) { return __awaiter(_this, void 0, void 0, function () {
        var payload, institution;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, api_1.getInstitutionById(id)];
                case 1:
                    payload = (_a.sent()).data;
                    institution = payload[0];
    ...
    var value = react_1.useMemo(function () {
        var allInstitutions = Object.values(institutionsById);
        return {
            allInstitutions: allInstitutions,
            institutionsById: institutionsById,
            getInstitutionById: getInstitutionById,
            getInstitutionsById: getInstitutionById,
            formatLogoSrc: formatLogoSrc
        };
    }, [institutionsById, getInstitutionById]);
    return react_1["default"].createElement(InstitutionsContext.Provider, __assign({ value: value }, props));
}
exports.InstitutionsProvider = InstitutionsProvider;
/**
...
function useInstitutions() {
    var context = react_1.useContext(InstitutionsContext);
    if (!context) {
        throw new Error("useInstitutions must be used within an InstitutionsProvider");
    }
    return context;
}
exports["default"] = useInstitutions;
/**
