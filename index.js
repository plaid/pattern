...
const PORT = process.env.PORT || 3000;  // Modified to include a default port if process.env.PORT is not set
...
app.get('/', (req, res) => {  // Added this line to handle requests to the root URL
